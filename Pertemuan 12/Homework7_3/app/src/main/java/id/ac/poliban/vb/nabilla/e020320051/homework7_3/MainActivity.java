package id.ac.poliban.vb.nabilla.e020320051.homework7_3;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_RANDOM_NUMBER = "id.ac.poliban.vb.nabilla.e020320051.homework 7_3.RANDOM_NUMBER";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("PowerReceiver - Nabilla");
