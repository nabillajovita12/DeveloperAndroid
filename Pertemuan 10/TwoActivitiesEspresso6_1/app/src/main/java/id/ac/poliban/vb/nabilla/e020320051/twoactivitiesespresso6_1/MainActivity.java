package id.ac.poliban.vb.nabilla.e020320051.twoactivitiesespresso6_1;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.vb.nabilla.e020320051.twoactivitiesespresso6_1.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Two Activities Espresso Test - Nabilla");
