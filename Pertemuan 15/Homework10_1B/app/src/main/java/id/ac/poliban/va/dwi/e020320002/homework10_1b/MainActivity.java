package id.ac.poliban.va.dwi.e020320002.homework10_1b;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.va.dwi.e020320002.homework10_1b";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Data Storage Types_Dwi");
