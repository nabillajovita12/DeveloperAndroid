package id.ac.poliban.vb.nabilla.e020320051.homework7_2;
...
import id.ac.poliban.va.dwi.e020320002.homework7_2.R;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Get Web Page Source Code - Nabilla");
