...
package id.ac.poliban.vb.nabilla.e020320051.whowroteltloader7_2;
...
import id.ac.poliban.va.dwi.e020320002.whowroteltloader7_2.R;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("WhoWroteItLoader - Nabilla");
